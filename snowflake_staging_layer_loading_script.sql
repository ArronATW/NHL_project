...
CREATE OR REPLACE TRANSIENT TABLE NHL_DB.STAGE_SCH.PLAYER_PICS (
    PLAYER_ID STRING,
    headshot STRING,
    heroImage STRING
);

COPY INTO NHL_DB.STAGE_SCH.PLAYER_PICS
FROM (
  SELECT 
    $1:playerId::STRING AS player_id,
    $1:headshot::STRING AS headshot_url,
    $1:heroImage::STRING AS hero_image_url
